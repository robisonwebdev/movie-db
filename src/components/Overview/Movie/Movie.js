...
const Movie = () => {
    ...
    const fetchData = useCallback(() => {
        const movieAPI = `https://api.themoviedb.org/3/movie/${id}?api_key=${api_key}&append_to_response=release_dates,credits,keywords,recommendations,reviews&&language=en-US`;
